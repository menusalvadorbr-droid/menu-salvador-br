...
/** Card de uma conversa de WhatsApp — prévia da última mensagem (com opção
 *  de expandir o histórico completo), resposta manual inline e "Marcar
 *  como resolvido". Reaproveitado tanto pela fila "IA precisa de você"
 *  (só precisa_humano=true) quanto por "Todas as conversas" (sem filtro),
 *  ambas em operador/. Sem callback de refetch: quem usa já assina
 *  Realtime em whatsapp_conversas, então responder/resolver atualizam a
 *  UI sozinhos assim que o banco muda. */
export default function CardConversa({
  estabelecimentoId,
  conversa,
}: {
